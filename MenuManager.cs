...
public class MenuManager : MonoBehaviour
{
   ...
   // [SerializeField]
   // private SplashScreen mainMenuPrefab;
    [SerializeField]
    private ControlsChecking mainMenuPrefab;
     [SerializeField]
    private CategoriesMenu categoriesPrefab;
  //  [SerializeField]
 //   private MapSelectionMenu mapSelectionMenuPrefab;
    [SerializeField]
    private BasicDrivingMenu BDTrainingMenuPrefab;
    [SerializeField]
    private BasicControlsMenu BasicCMenuPrefab;
    [SerializeField]
    private CockpitDrillMenu CockpitDrillMenuPrefab;

    [SerializeField]
    private LessonsMenu LessonsMenuPrefab;

    [SerializeField]
    private FootControlsMenu FootCMenuPrefab;
    [SerializeField]
    private DashboardMenu DashboardsMenuPrefab;
    [SerializeField]
    private HandControlsMenu HandCMenuPrefab;
    [SerializeField]
    private VideosMenu VideosMenuPrefab;
    [SerializeField]
    private TestMenu TestMenuPrefab;

    // [SerializeField]
    //ram  private HUD hudMenuPrefab;
    //private CreditsScreen creditsScreenPrefab;
    [SerializeField]
    private LoadingMenu loadingMenuPrefab;
    [SerializeField]
    private WinScreen winScreenPrefab;
    [SerializeField]
    private LessonCompleted lessonCompletionPrefab;
    [SerializeField]
